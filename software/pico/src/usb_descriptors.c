...
#define CDC_VID 0x2E8A // Raspberry Pi Foundation
#define CDC_PID 0x4242
// set USB 2.0
...
char const *string_desc_arr[] = {
    ...
    "Maerki",                   // 1: Manufacturer
    "ad_low_noise_float_2023",  // 2: Product
    NULL,                       // 3: Serials (null so it uses unique ID if available)
    "Mesurement datastream"     // 4: CDC Interface 0
